...
tags: [policy-based-learning, game-ai, npc-behavior, large-language-model, function-approximation, reinforcement-learning, experiment-1]
thumbnail: /src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/fuzzy_policy.png
---
...
[//]: # (<LightboxVideo previewImgSrc="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/gridworld.png")
...
of research (with a good example being the [Nethack Learning Environment](https://github.com/heiner/nle)),
and producing good results requires <i>a lot</i> of computing power. One of the questions that these experiments are
attempting to answer is whether we can use LLMs to significantly reduce the complexity and time taken to produce a
good enough policy.
...
[//]: # (<LightboxImage src="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/gridworld.png")

[//]: # (               alt="Experiment 1 Gridworld")

[//]: # (               class="max-h-[512px]"/>)

<LightboxVideo previewImgSrc="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/gridworld-video-preview.png"
               inlineImgSrc="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/gridworld-inline.png"
               src="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/gridworld.mp4"
               alt="Experiment 1 Gridworld"
               caption="Gridworld in action. Click to play video."
               />
...
[//]: # (<EmbeddedYouTube youtubeId="ypDRAv9NrBI" caption="Gridworld in action" />)
...
<div>
    <LightboxImage src="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/raw_policy.png"
                   alt="Raw Policy" />
    ...
    <ContentWarning>
        ...
        [//]: # (  - `1` if `T` is greater than or equal to `30`.)
            ...
            <LightboxImage src="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/fuzzy_membership_temp.png"
            ...
            <LightboxImage src="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/2d_fuzzy_patches.png"
    ...
    <LightboxImage src="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/fuzzy_policy.png"
                   alt="Fuzzy Policy" />
    ...
    <LightboxImage src="/src/assets/images/hiivelabs.com/blog/2024-10-30-ml-experiments-pt-1/fuzzy_raw_policy.png"
