...
description: |
  ...
  more in-depth technical explorations in future posts.  It provides insight into the project’s initial implementation,
  early design decisions, and the challenges encountered along the way. This foundation will help contextualize the
  transition to Rust and the refinements made during the process.
author: hiive
categories: gamedev roguelike
tags: world-building terrain-generation procedural-generation c-sharp rust
thumbnail: /src/assets/images/hiivelabs.com/blog/world_roads_and_capitals.png
---
...
<LightboxGallery caption="Image Gallery: Terrain Generation Component Images">
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/modulated_altitude_map.png"
                  alt="Terrain-modulated Altitude Map"
                  caption="Terrain-modulated Altitude Map"
    />
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/world_precipitation.png"
                  alt="Precipitation Map"
                  caption="Precipitation Map"
    />
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/world_heatmap.png"
...
<YouTube id="vxD22Ptloqc" class="ml-4 mb-4" />
<div class="lightbox-caption">VIDEO: The proto-FAWN Engine</div>
