...
author: hiive
description: >
  A deep dive into using cellular automata for procedural content generation,
  exploring discrete and continuous CA

  frameworks, custom scripting language features, visual examples, and
  post-processing techniques for game development.

  The discussion also touches on the challenges of transitioning a custom CA
  scripting language from C# to Rust and

  explores potential enhancements, such as convolution kernels and flexible rule
  definitions. Future improvements

  focus on integrating multiple CA-based techniques to generate seamless,
  expansive procedural worlds.
thumbnail: >-
  /src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/thumbnail.png
categories:
  - gamedev
  - cellular-automata
...
Conway's Life is probably the most famous CA. Among Roguelike developers, however, the use of CAs for generating maps of [cave layouts](https://www.roguebasin.com/index.php/Cellular_Automata_Method_for_Generating_Random_Cave-Like_Levels) is well known. Similarly, the original [SimCity](https://en.wikipedia.org/wiki/SimCity_\(1989_video_game\)) relied on
...
more flexible and extensible while still handling the key details. The typical Game of Life rulestring, `B3/S23`, can be translated directly into the script above (`B3` = a dead cell becomes alive with exactly 3 neighbors, `S23` = a living cell remains alive with 2 or 3 neighbors).
...
<LightboxGallery caption="Image Gallery: Script Editor running Conway's Life">
  <GalleryImage
    image="/src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/ca-editor.png"
...
displays 'No errors,' confirming the simulation has run successfully."
  ...
  <GalleryImage
    image="/src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/ca-editor-glider.png"
...
<LightboxImage
  image="/src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/glider.png"
...
<LightboxImage
  image="/src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/ca-maze.png"
...
<LightboxImage
  image="/src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/ca-mazectric.png"
...
<LightboxImage
  image="/src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/ca-cave.png"
...
<LightboxImage
  image="/src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/ca-cave-postprocess.png"
...
Recently, an indie game developer, [Loren Schmidt](https://bsky.app/profile/lorenschmidt.bsky.social), has been doing impressive work using CAs to generate landscapes and cityscapes for a roguelike. Following their progress on Bluesky reignited an interest in revisiting the existing CA codebase to see if it could support more advanced CAs. As of now, it cannot, so there is room for improvements during the Rust conversion.

In particular, Loren’s work (they also have a [Patreon](https://www.patreon.com/vacuumflowers) that is well worth supporting if you're interested in CAs), got me thinking about how far CA research has come from 2D discrete grids. There has been significant development around continuous-space CAs, such as [Lenia](https://en.wikipedia.org/wiki/Lenia). Lenia implements multichannel, multidimensional continuous space and time CAs, using techniques like convolution kernels to define neighbor relationships.

<LightboxImage
  image="/src/assets/images/hiivelabs.com/blog/2025-01-06-cellular-automata/ca-lenia.png"
