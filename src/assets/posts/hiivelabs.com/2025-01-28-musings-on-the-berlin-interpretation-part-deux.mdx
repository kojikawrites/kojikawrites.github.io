...
Popular games like <SteamLink steam_id="1145360">Hades</SteamLink>, <SteamLink steam_id="250900">Binding of Isaac</SteamLink>,
and <SteamLink steam_id="588650">Dead Cells</SteamLink> highlight the growing influence of roguelites, while titles such
as <SteamLink steam_id="646570">*Slay the Spire*</SteamLink> and <SteamLink steam_id="2379780">*Balatro*</SteamLink>
demonstrate new mechanics (in this case, deck building) that blur the lines between categories. These shifts in the
...
Similarly, <WikiLink wiki_id="Dungeon_Crawl_Stone_Soup">*Dungeon Crawl Stone Soup (DCSS)*</WikiLink> balances procedural
...
In contrast to roguelites like <SteamLink steam_id="1145360">Hades</SteamLink>,
...
strategy games like <WikiLink wiki_id="X-COM:_UFO_Defense">*XCOM: UFO Defense*</WikiLink>, roguelikes often revolve around a single
hero whose survival is paramount. Every injury or setback feels personal, amplifying the tension of every turn or
encounter.
...
example, in <WikiLink wiki_id="NetHack">*NetHack*</WikiLink> or <SteamLink steam_id="333300">*ADOM*</SteamLink>,
losing a high-level character can be devastating, but the lessons learned along the way prepare players for future runs.
...
For instance, in <WikiLink wiki_id="Dungeon_Crawl_Stone_Soup">*DCSS*</WikiLink>, players often encounter treasure vaults
or heavily guarded chambers containing valuable equipment or consumables. Accessing these rewards usually requires
...
In games like <SteamLink steam_id="212680">*FTL*</SteamLink> or <SteamLink steam_id="811320">*Jupiter Hell*</SteamLink>,
players often face situations where their initial plans must evolve based on the resources available or the threats
encountered. This adaptability keeps gameplay dynamic and ensures that players are always engaged, responding to the
unique challenges of each run.
...
environments and characters while retaining
...
starship exploration and planetary away missions, proving that a roguelike’s core identity transcends its setting.
As long as the game fosters tension and unpredictability, the environment can be as varied as the designer’s imagination
allows.
...
-	<SteamLink steam_id="241600">*Rogue Legacy*</SteamLink>: Features generational meta-progression, where each new
        character inherits traits and upgrades from previous runs.
...
Traditional roguelikes represent the direct descendants of early genre-defining titles like
...
- A quintessential example of a traditional roguelike, <WikiLink wiki_id="Dungeon_Crawl_Stone_Soup">*DCSS*</WikiLink>
...
#### *Jupiter Hell*
- Blending the sci-fi setting of Doom with traditional roguelike mechanics,
<SteamLink steam_id="811320">*Jupiter Hell*</SteamLink> delivers turn-based tactical gameplay with a modern twist. Its
clear interface and tactical pacing make every decision impactful, while its procedural design ensures consistent
replayability.

#### *FTL: Faster Than Light*
- While not a traditional roguelike, <SteamLink steam_id="212680">*FTL*</SteamLink> embraces procedural generation,
high-stakes decision-making, and resource management. Its real-time-with-pause mechanics balance tactical and strategic
elements, offering a fresh interpretation of roguelike principles within a sci-fi framework.

#### *Brogue*
- Grid-based movement, turn-based combat, and procedurally generated dungeons.
<WikiLink wiki_id="Brogue_(video_game)">*Brogue*</WikiLink> exemplifies classic roguelike design, with a heavy emphasis
...
- Procedural complexity, emergent storytelling, and high-stakes tactical play. The Adventure Mode in
<SteamLink steam_id="975370">*Dwarf Fortress*</SteamLink> offers a highly simulated world where players control a single
...
#### *Dead Cells*
- Blending procedural generation with fluid platforming combat, <SteamLink steam_id="588650">*Dead Cells*</SteamLink>
exemplifies the roguelite approach. Unlockable weapons and abilities provide long-term progression, while its
reflex-heavy gameplay moves away from the tactical pacing of roguelikes.

#### *Rogue Legacy*
- Well known for its generational progression system, <SteamLink steam_id="241600">*Rogue Legacy*</SteamLink>
allows players to invest in upgrades that persist across runs. While it retains a run-based structure, the focus on
long-term character growth sets it firmly in the roguelite camp.

#### *Binding of Isaac*
- Reflex-based combat, procedural generation, and persistent upgrades. <SteamLink steam_id="250900">*Binding of Isaac*</SteamLink>
emphasizes fast-paced gameplay, with unlockable items and abilities that carry over between runs. While procedural
elements align with roguelikes, the focus on reflexes and meta-progression differentiates it as a roguelite.
...
- Action RPG mechanics, procedural dungeons, and persistent town upgrades. *Heroes of Hammerwatch*
<SteamLink steam_id="677120">*1*</SteamLink> and <SteamLink steam_id="619820">*2*</SteamLink> integrate roguelite
...
#### *Spelunky 1 and 2*
- Platforming, procedural generation, and reflex-heavy gameplay. <WikiLink wiki_id="Spelunky">*Spelunky*</WikiLink>
<SteamLink steam_id="239350">*1*</SteamLink> and <SteamLink steam_id="418530">*2*</SteamLink> incorporate roguelike
randomness but rely on player reflexes and precise timing to navigate their environments.
The games lack traditional roguelike tactical pacing, making them the quintessential roguelites.

#### *Diablo*
- Procedural generation, loot-based progression, and persistent character development. While
<WikiLink wiki_id="Diablo_(video_game)">*Diablo*</WikiLink> leans heavily on action RPG mechanics, along with a rigid
story and set pieces, its use of randomization and high replayability align it with roguelite design principles.
Unlike traditional roguelikes, it focuses on real-time combat and long-term character upgrades, making it more
...
- <SteamLink steam_id="975370">*Dwarf Fortress*</SteamLink> combines traditional roguelike elements like procedural
...
#### *KeeperRL*
- Grid-based movement, turn-based mechanics, and a mix of roguelike and simulation elements.
<SteamLink steam_id="329970">*KeeperRL*</SteamLink> combines traditional dungeon-building mechanics with roguelike
exploration and combat, allowing players to control both individual units and broader dungeon systems.

#### *Balatro*
- Combines roguelike principles with deck-building mechanics and a focus on improvisational gameplay.
<SteamLink steam_id="2379780">*Balatro*</SteamLink> tasks players with building and managing a deck of cards as they
navigate procedurally generated challenges. The game emphasizes adaptability, as the random nature of card draws and
events requires players to adjust their strategies on the fly.
Like traditional roguelikes, the game features high-stakes decision-making,
where each play or resource expenditure can significantly impact the outcome of a run. However, its use of deck-building
mechanics places it in the hybrid category, blending the emergent complexity of roguelikes with the planning and
synergies typical of card-based games.

#### *Slay the Spire*
- <SteamLink steam_id="646570">*Slay the Spire*</SteamLink> merges deck-building card game mechanics with roguelike
progression. Players ascend a procedurally generated spire, battling enemies through turn-based card combat.
Each run offers different cards and relics, encouraging players to adapt their strategies and build unique decks to
overcome challenges

#### *Darkest Dungeon II*
- <SteamLink steam_id="1940340">Darkest Dungeon II</SteamLink> builds upon its predecessor’s focus on party-based tactics
and resource management but introduces deeper narrative integration and persistent progression systems. While each combat
encounter requires strategic, moment-to-moment decisions consistent with roguelike principles, the overarching story
and legacy systems provide continuity and long-term objectives.
...
<WikiLink wiki_id="Angband_(video_game)">*Angbad*</WikiLink>.
...
<SteamLink steam_id="811320">*Jupiter Hell*</SteamLink> demonstrate that roguelikes can embrace modern visuals while
retaining their tactical depth. Similarly, hybrids like <SteamLink steam_id="329970">*KeeperRL*</SteamLink> show how
blending genres can attract new audiences while preserving roguelike principles.
...
For example, games like <SteamLink steam_id="1282730">*Loop Hero*</SteamLink>, *Rift Wizard*
...
Finally, because I like pictures, here's a non-exhaustive Rogues Gallery (see what I did there?) of notable roguelikes.
<LightboxGallery>
    <GalleryEntry
