...
description: |
    This post explains an adaptive approach for downscaling pixel art while preserving detail, combining naive
    resampling, block-based color sampling, edge detection, and conditional replacement to produce sharper results.
    It’s implemented in Python with code in a GitHub repository. The approach merges standard scaling with specialized
    steps to handle transparency, edges, and color distribution.
...
<LightboxGallery>
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/house_orig.png"
                  alt="The input image"
                  description="Step 0: The input image"/>
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/house_naive_scale.png"
                  alt="Naively downsampled original image"
                  description="Step 1: A naively downsampled version of the original image.
    ...
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/house_mcbs.png"
                  alt="Majority color block downsampling of the original image"
                  description="Step 2a: Majority color block downsampling of the original image.
    ...
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/house_epd.png"
                  alt="Edge preserving downscale of the image from step 2(a)"
                  description="Step 2b: Edge preserving downscale of the image from step 2(a).
    ...
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/house_mask.png"
                  alt="The transparency mask for the downsampled image."
                  description="Step 3: The downsampled image mask"/>
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/house_final.png"
                  alt="This image is the result of the original naive downsampled image
                  overlaid with the results of step 2(b), giving us a nicely downsampled image
                  while still preserving edge details."
                  description="Step 4: The final output image"/>
...
<LightboxGallery>
    ...
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/character_mcbs.png"
                  alt="Majority color block downsampling of the original image"
                  description="Step 2: Majority color block downsampling of the original image."/>
    ...
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/character_final.png"
                  ...
                  description="Step 4: The final output image (2× reduction)"/>
    <GalleryEntry src="/src/assets/images/hiivelabs.com/blog/pixel/character_final_x3.png"
                  alt="Bonus image. This is reduced by a factor 3×, and is about as small
                  as it can get while still retaining enough detail to be usable."
                  description="Step 4: The final output image (3× reduction)"/>
</LightboxGallery>
