...
thumbnail: /src/assets/images/hiivelabs.com/blog/pixel/house_final.png
---

## TLDR;
Before getting started, the code discussed in this post is available
<GithubLink path="hiive/pixel_scale">here</GithubLink>
...
The naive downscales lose significant detail, while the adaptive approach retains edges, shading, and transparency
more effectively.

<LightboxGallery caption="Image Gallery: Adaptive Downscale Sequence">
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house_orig.png"
                  description="The input image"
                  caption="Input Image"
                  alt="Step 0: The input image"/>
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house_naive_scale.png"
    ...
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house_mcbs.png"
                  description="Majority color block downscaling of the original image"
                  caption="MCB Downscale"
                  alt="Step 2a: Majority color block downscaling of the original image.
                  Detail is preserved, but some pixel transitions are quite jarring."/>
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house_epd.png"
                  caption="Edge Downscale"
    ...
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house_mask.png"
                  description="The transparency mask for the downscaled image."
                  caption="Transparency Mask"
                  alt="Step 3: The downscaled image mask"/>
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house_final.png"
                  caption="Final Output ↓3×"
                  description="This image is the result of the original naive downscaled image
                  overlaid with the results of step 2(b), giving us a nicely downscaled image
...
<LightboxGallery caption="Image Gallery: Downscale Examples">
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house-example-nearest-neighbor.png"
                  caption="Nearest Neighbor"
                  alt="Nearest Neighbor downscaling examples." />
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house-example-bilinear.png"
                  caption="Bilinear Sampling"
                  alt="Bilinear downscaling examples." />
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/house-example-detail-aware.png"
                  caption="Adaptive Detail Aware"
                  alt="Detail aware downscaling examples." />
</LightboxGallery>
...
<LightboxGallery caption="Image Gallery: Adaptive Downscale Sequence">
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/character_orig.png"
                  description="The input image."
                  caption="Input Image"
                  alt="Step 0: The input image."/>
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/character_naive_scale.png"
                  description="Naively downscaled original image."
                  caption="Naive Downscale"
                  alt="Step 1: A naively downscaled version of the original image.
                  The loss of detail due to downscaling is evident."/>
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/character_mcbs.png"
                  description="Majority color block downscaling of the original image."
                  caption="MCB Downscale"
                  alt="Step 2: Majority color block downscaling of the original image."/>
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/character_mask.png"
                  description="The transparency mask for the downscaled image."
                  caption="Transparency Mask"
                  alt="Step 3: The downscaled image mask."/>
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/character_final.png"
                  description="This image is the result of the original naive downscaled image
                  overlaid with the results of step 2, giving us a nicely downscaled image
                  while still preserving most details."
                  caption="Final Output ↓2×"
                  alt="Step 4: The final output image (2× reduction)."/>
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/character_final_x3.png"
                  caption="Final Output ↓3×"
...
<LightboxImage src="/src/assets/images/hiivelabs.com/blog/pixel/char_examples.png"
               alt="Adaptive downscaling character examples."
               />

<LightboxImage src="/src/assets/images/hiivelabs.com/blog/pixel/char_examples_nn.png"
               alt="Nearest Neighbor downscaling character examples."
               />

<LightboxImage src="/src/assets/images/hiivelabs.com/blog/pixel/char_examples_bilinear.png"
               alt="Bilinear Filtering downscaling character examples."
               />

## Lastly, a reminder...

The code discussed in this post (plus any updates made since this post) is available
<GithubLink path="hiive/pixel_scale">here</GithubLink>. PRs for corrections or improvements are always welcome.


## Postscript

Update <FormattedDate date="1/21/2025" />: I conducted additional tests of the algorithm after posting the above to
assess how well it handles an “extreme” case. I chose the well-known Yoshi sprite from Super Mario World on the SNES.
This was a challenging test because the sprite contains a lot of detail packed into its 32×32 pixel grid.

The following images display, in order, the input 32×32 Yoshi sprite, the 16×16 nearest neighbor downscaled sprite,
the 16×16 bilinear downscaled sprite, and finally the 16×16 adaptive detail downscaled sprite.

<LightboxGallery caption="Image Gallery: Adaptive Downscaling Stress Test">
    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/yoshi_original.png"
                  caption="32×32 Yoshi"
                  alt="Original 32×32 Yoshi sprite."
    />

    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/yoshi_nn.png"
                  caption="16×16 Nearest Neighbor"
                  alt="16×16 Nearest Neighbor downscaled Yoshi sprite."
    />

    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/yoshi_bilinear.png"
                  caption="16×16 Bilinear Sample"
                  alt="16×16 bilinear downscaled Yoshi sprite."
    />

    <GalleryImage src="/src/assets/images/hiivelabs.com/blog/pixel/yoshi_adaptive.png"
                  caption="16×16 Adaptive Sample"
                  alt="16×16 Adaptive detail downscaled Yoshi sprite."
    />
</LightboxGallery>

Although, in my opinion, adaptive downscaling still produces the best results, the output isn’t as good as what a
skilled pixel artist could achieve. This demonstrates that with highly detailed source images, the algorithm is limited
in what it can compress into a smaller space.

However, if we use the adaptive downscaling output for heavily outlined sprites as a time-saving step that can be
manually tweaked during post-processing, the algorithm appears to be up to the challenge.
