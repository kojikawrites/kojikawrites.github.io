...
author: hiive
description: >-
  This post explains an adaptive approach for downscaling pixel art while
  preserving detail, combining naive resampling, block-based color sampling,
  edge detection, and conditional replacement to produce sharper results. It’s
  implemented in Python with code in a GitHub repository. The approach merges
  standard scaling with specialized steps to handle transparency, edges, and
  color distribution.
thumbnail: >-
  /src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/thumbnail.png
categories:
  - gamedev
  - graphics
tags:
...
<LightboxGallery caption="Image Gallery: Adaptive Downscale Sequence">
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house_orig.png" alt="Step 0: The input image" description="The input image" caption="Input Image" />

  <GalleryImage
    image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house_naive_scale.png"
    alt="Step 1: A naively downscaled version of the original image.
The loss of detail due to downscaling is evident."
    description="Naively downscaled original image"
    caption="Naive Downscale"
  />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house_mcbs.png" alt="Step 2(a): Majority color block downscaling of the original image. Detail is preserved, but some pixel transitions are quite jarring." description="Majority color block downscaling of the original image" caption="MCB Downscale" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house_epd.png" alt="Step 2(b): Edge preserving downscale of the image from step 2(a). Edge detail is preserved. Everything else is left transparent." description="Edge preserving downscale of the image from step 2(a)" caption="Edge Downscale" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house_mask.png" alt="Step 3: The downscaled image mask" description="The transparency mask for the downscaled image." caption="Transparency Mask" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house_final.png" src="/src/assets/images/hiivelabs.com/blog/pixel/house_final.png" alt="Step 4: The final output image" description="This image is the result of the original naive downscaled image overlaid with the results of step 2(b), giving us a nicely downscaled image while still preserving edge details." caption="Final Output ↓3×" />
</LightboxGallery>

The original input image.

<LightboxImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house_orig.png" alt="Step 0: The input image" description="The input image" />
...
<LightboxImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house_final.png" alt="Step 4: The final output image" description="The output image" />
...
<LightboxGallery caption="Image Gallery: Downscale Examples">
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house-example-nearest-neighbor.png" alt="Nearest Neighbor downscaling examples." caption="Nearest Neighbor" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house-example-bilinear.png" alt="Bilinear downscaling examples." caption="Bilinear Sampling" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/house-example-detail-aware.png" alt="Detail aware downscaling examples." caption="Adaptive Detail Aware" />
</LightboxGallery>
...
<LightboxGallery caption="Image Gallery: Adaptive Downscale Sequence">
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/character_orig.png" alt="Step 0: The input image." description="The input image." caption="Input Image" />

  <GalleryImage
    image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/character_naive_scale.png"
    alt="Step 1: A naively downscaled version of the original image.
The loss of detail due to downscaling is evident."
    description="Naively downscaled original image."
    caption="Naive Downscale"
  ...
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/character_mcbs.png" alt="Step 2: Majority color block downscaling of the original image." description="Majority color block downscaling of the original image." caption="MCB Downscale" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/character_mask.png" alt="Step 3: The downscaled image mask." description="The transparency mask for the downscaled image." caption="Transparency Mask" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/character_final.png" alt="Step 4: The final output image (2× reduction)." description="This image is the result of the original naive downscaled image overlaid with the results of step 2, giving us a nicely downscaled image while still preserving most details." caption="Final Output ↓2×" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/character_final_x3.png" alt="Step 4: The final output image (3× reduction)." description="Bonus image. This is reduced by a factor 3×, and is about as small as it can get while still retaining enough detail to be usable." caption="Final Output ↓3×" />
</LightboxGallery>
...
<LightboxImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/char_examples.png" alt="Adaptive downscaling character examples." />

<LightboxImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/char_examples_nn.png" alt="Nearest Neighbor downscaling character examples." />

<LightboxImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/char_examples_bilinear.png" alt="Bilinear Filtering downscaling character examples." />

## Lastly, a reminder...

The code discussed in this post (plus any updates made since this post) is available [here](https://github.com/hiive/pixel_scale). PRs for corrections or improvements are always welcome.

## Postscript

Update <FormattedDate date={"2025-01-21"} />: I conducted additional tests of the algorithm after posting the above to assess how well it handles an “extreme” case. I chose the well-known Yoshi sprite from Super Mario World on the SNES. This was a challenging test because the sprite contains a lot of detail packed into its 32×32 pixel grid.
...
<LightboxGallery caption="Image Gallery: Adaptive Downscaling Stress Test">
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/yoshi_original.png" alt="Original 32×32 Yoshi sprite." caption="32×32 Yoshi" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/yoshi_nn.png" alt="16×16 Nearest Neighbor downscaled Yoshi sprite." caption="16×16 Nearest Neighbor" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/yoshi_bilinear.png" alt="16×16 bilinear downscaled Yoshi sprite." caption="16×16 Bilinear Sample" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-19-adaptive-downscaling-pixel-art/yoshi_adaptive.png" alt="16×16 Adaptive detail downscaled Yoshi sprite." caption="16×16 Adaptive Sample" />
</LightboxGallery>
