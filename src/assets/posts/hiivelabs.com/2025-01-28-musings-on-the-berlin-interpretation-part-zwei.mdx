...
---
<ContentWarning>
    <div slot="warning">THIS ARTICLE IS CURRENTLY IN DRAFT!</div>
    <div slot="content">
    # \*\* SERIOUSLY! THIS ARTICLE IS A WIP! \*\*
    </div>
</ContentWarning>
...
few distinctive features. Let's start with what, prior to writing this article, were arguably considered to be the
...
argument is that, as long as the game met the criteria for principle, it should be classified as a roguelike.
...
Small static components (e.g., <SteamLink steam_id="333640">*Caves of Qud*</SteamLink>’s)
overworld map, <SteamLink steam_id="333300">*ADOM*</SteamLink>’s static quest hubs) are allowed if used sparingly.
Similarly, pre-designed boss arenas or story-critical locations
(e.g., <SteamLink steam_id="811320">*Jupiter Hell*</SteamLink>’s final level) are also acceptable.
...
- #### (ii) Spatial Systems
    ...
    <SteamLink steam_id="268130">Heat Signature</SteamLink>’s paused planning or
    <SteamLink steam_id="342610">*HyperRogue*</SteamLink>’s non-Euclidean geometry.

    Systems that lack tactical positioning or rely on reflex-driven mechanics would likely disqualify a game from the
    roguelike genre. For example, chaotic freeform movement like <WikiLink wiki_id="Diablo_(video_game)">*Diablo*</WikiLink>’s
    click-to-move combat fails to provide meaningful positional strategy. Similarly, fast-paced, reflex-heavy systems such
...
To my thinking, games that qualify as "true" roguelikes come is three flavors. First is the Traditional Roguelike.
Secondly, the Modern Roguelike; capable of being almost indistinguishable at first glance from the Traditional Roguelike,
but with features that vary slightly from the traditional roguelike tenets, but that still adhere to the more relaxed
tenets presented in section II of this document. Thirdly, are the hybrid roguelikes; these are games that adhere to most
of the tenets, but completely violate, or even omit, one or more of them. Lastly, there is a fourth category, the
roguelite; these are games that borrow from maybe one or two of the tenets, but completely replace others with totally
different systems. In this section, we will cover the first three of these categories. Roguelites will be covered in
the next section.

This classification scheme is not perfect. There are cases where deciding how to categorize a particular game is very
difficult, as it could seem to be in two categories at once. For this reason, it is best to view these classifications
as a continuum rather than a set of category buckets, whereby a game could validly be described as being in more than one
...
## VI. Addressing Community Concerns
...
- ### Cultural Conflation
    ...
    and cinematic storytelling over tactical decision-making.
...
<LightboxGallery caption="Image Gallery: These are NOT roguelikes">
    ...
    <GalleryEntry
        ...
        caption="Returnal"
        description="Screenshot of Returnal, a third-person shooter rogulite with procedural generation and permadeath."
    />
    <GalleryEntry
...
## VII. Creative Freedom and Evolution
...
## VIII. A Practical Checklist for Roguelike Classification
...
### The Checklist
Use this checklist as a conversation tool, not a taxonomy. The best roguelike-adjacent games defy categorization,
borrowing ideas freely while respecting the genre’s core tension: risk versus reward, chaos versus control.
<div class="checklist">
