...
-	***Meta-Progression***:
    ...
    where every new attempt starts from scratch -- meta-progression allows players to unlock new abilities, characters,
    or resources over time, which can alter the overall game experience without undermining the core challenge.
-	***Tactical Depth***:
