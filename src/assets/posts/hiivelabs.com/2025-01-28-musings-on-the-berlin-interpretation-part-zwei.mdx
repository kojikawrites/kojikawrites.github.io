...
To qualify as a roguelike, a game should adhere to the following principles:
...
- #### (i) Turn-Based or Pauseable Real-Time
...
- #### (ii) Exclusion of Reflex-Driven Gameplay
...
### Contemporary Role
Some modern roguelikes and roguelites such as <SteamLink steam_id="247080">*Crypt of the Necrodancer*</SteamLink>
have introduced faster pacing, reflex elements, and persistent upgrades, but traditional roguelikes continue to thrive
in both classic and newly developed titles.
They provide a counterbalance to more action-focused designs, offering a pure, methodical experience that remains
beloved by those who prefer careful deliberation, emergent complexity, and the high stakes of permanent failure.
...
<LightboxGallery caption="Image Gallery: Roguelikes">
    ...
    />
    <GalleryEntry
        src="/src/assets/images/hiivelabs.com/blog/bi2/path_of_achra.jpg"
