...
author: hiive
description: >-
  This article introduces “The Hiive Interpretation,” a modern framework for
  defining roguelikes inspired by the original Berlin Interpretation. It
  reexamines core principles to accommodate contemporary game designs,
  distinguishing between traditional roguelikes, roguelites, and hybrids.
  Through detailed analysis and case studies of notable games, the post aims to
  foster clearer discussions and understanding within the roguelike community.
  The goal is to provide a flexible, insightful tool that respects the genre’s
  legacy while embracing its evolution.
categories:
  - gamedev
  - roguelike
tags:
...
thumbnail: >-
  /src/assets/images/hiivelabs.com/blog/2025-01-28-musings-on-the-berlin-interpretation-part-zwei/thumbnail.jpg
---
## Revisiting Berlin...

About six months ago, I wrote a [post](/blog/gamedev/roguelike/2024/07/11/musings-on-the-berlin-interpretation) critiquing the original Berlin Interpretation of roguelike games, That piece generated some thoughtful discussion, which led me to reflect further on how I might improve and refine the interpretation to account for all the developments and advances in the genre since 2008.
...
* *Tactical Depth*: Games like [*Dungeon Crawl Stone Soup (DCSS)*](https://github.com/crawl/crawl) and [*Brogue*](https://github.com/tmewett/BrogueCE) use procedural generation to craft unpredictable, high-stakes scenarios where every decision matters.
* *Adventure Simulation*: Titles like [*Caves of Qud*](https://store.steampowered.com/app/333640/) and [*Cogmind*](https://store.steampowered.com/app/722730/) prioritize systemic reactivity, letting players shape stories through interactions with a living world.

These styles aren’t mutually exclusive -- for example, [*Cogmind*](https://store.steampowered.com/app/722730/) blends tactical play with procedural storytelling and large scale world simulation.
...
* *Tactical Philosophy:* Emphasizes **fast-paced decision-making**, mechanical clarity, and immediate feedback. Games like [*DCSS*](https://github.com/crawl/crawl) and [*Jupiter Hell*](https://store.steampowered.com/app/811320) exemplify this approach, focusing on moment-to-moment positioning and risk-reward optimization. Procedural generation here creates unpredictable *challenges* (e.g., vault layouts, enemy spawns).
* *Simulationist Philosophy:* Prioritizes **systemic reactivity**, environmental storytelling, and player
  imagination. Titles like [*Caves of Qud*](https://store.steampowered.com/app/333640/) and [*Ancient  Domains of Mystery (ADOM)*](https://store.steampowered.com/app/333300) use procedural generation to craft *narrative possibilities* (e.g., faction conflicts, procedurally generated lore). These games trade tactical  mmediacy for emergent storytelling.

Hybrids like [*Dwarf Fortress (Adventure Mode)*](https://store.steampowered.com/app/975370) blend these philosophies but often lean toward one pole.
...
Other modern games like [*Hades*](https://store.steampowered.com/app/1145360), [*Binding of Isaac*](https://store.steampowered.com/app/250900), and [*Dead Cells*](https://store.steampowered.com/app/588650) exhibit the influence of roguelikes, while titles such as [*Slay the Spire*](https://store.steampowered.com/app/646570) and [*Balatro*](https://store.steampowered.com/app/2379780) demonstrate new mechanics (in this case, deck building) that blur the lines between genres. These shifts in the gaming landscape call for a more nuanced understanding of what defines a roguelike today.
...
(Of course, they're sometimes also referred to as roguelikes -- but that's another issue, and one that only serves to unhelpfully muddy the definitions further. Personally, I refer to games such as [*Brogue*](https://github.com/tmewett/BrogueCE) as "traditional roguelikes" and [*Caves of Qud*](https://store.steampowered.com/app/333640/) as "modern roguelikes", whereas a I would call a game like [*Heroes of Hammerwatch*](https://store.steampowered.com/app/677120) a "roguelite" or "action roguelite". Part of the purpose of writing this definition is to clear up some of the confusion regarding genre classification of these types of game.)
...
Besides, pretty much every rogueli<EquationSnippet equation="x" inline />e<FootnoteRef id="1" />  aficionado has an opinion on this, so here's mine...

<FootnoteDefinition id="1">
  Where:  <EquationSnippet equation="x \in \set{k|t}" inline style="position:relative; top: 4px;" />.
</FootnoteDefinition>
...
The roguelike genre has its roots in early classics like [*Rogue*](https://en.wikipedia.org/wiki/Rogue_\(video_game\)), [*NetHack*](https://github.com/NetHack/NetHack), [*ADOM*](https://store.steampowered.com/app/333300) and [*Tales of Maj'Eyal (ToME)*](https://store.steampowered.com/app/259680). These games laid the groundwork for procedural exploration, tense encounters, and meaningful consequences, which remain essential to the genre’s appeal.
...
Some static components (e.g., [*Caves of Qud's*](https://store.steampowered.com/app/333640/) overworld map, [*ADOM's*](https://store.steampowered.com/app/333300) static quest hubs) are allowed if used sparingly. Similarly, pre-designed boss arenas or story-critical locations (e.g., [*Jupiter Hell's*](https://store.steampowered.com/app/811320) final level) are also acceptable.
...
* #### (ii) Balanced Unpredictability
  ...
  While randomness is essential, it’s most compelling when paired with thoughtful design. Games like [*Caves of Qud*](https://store.steampowered.com/app/333640/) achieve this by anchoring their worlds with consistent faction ecosystems, ensuring that even unpredictable events feel grounded in logic. Similarly, [*DCSS*](https://github.com/crawl/crawl) balances procedural generation with carefully tuned systems, creating a sense of coherence without sacrificing variety.
...
* #### (i) Time Mechanics
  ...
  Turn-based roguelikes, such as [*NetHack*](https://github.com/NetHack/NetHack), or [*Zorbus*](https://store.steampowered.com/app/2125420), give players the space to carefully weigh their moves, while games [*FTL: Faster Than Light*](https://store.steampowered.com/app/212680) use a pauseable real-time system to achieve a similar level of tactical control. Both approaches reward foresight and encourage players to think critically about positioning, timing, and resource use.

  ##### Exclusion of Reflex-Driven Gameplay

  In contrast to action roguelites like [*Hades*](https://store.steampowered.com/app/1145360), [*Returnal*](https://store.steampowered.com/app/1649240), or the *Risk of Rain* series ([2013 Edition](https://store.steampowered.com/app/248820), [Sequel](https://store.steampowered.com/app/632360), [Remaster of 2013 Edition](https://store.steampowered.com/app/1337520)), roguelikes avoid reflex-driven gameplay. These games emphasize thoughtful choices and improvisation over quick reactions. While action roguelites offer fast-paced excitement, roguelikes create engagement through intentional pacing, where each move can be considered carefully. There are no real-time limited decisions in a roguelike, other than those you set for yourself.
* #### (ii) Spatial Systems

  Roguelikes may employ a variety of spatial systems, provided they enable tactical decision-making through measurable risk-reward mechanics (e.g., line-of-sight, flanking, environmental interactions). Traditional 2D (or higher dimensional) grids -- usually square or hex based -- are the gold standard, offering clear positional clarity. However, other systems are permissible if it retains tactical depth, such as [*Heat Signature's*](https://store.steampowered.com/app/268130) paused planning or [*HyperRogue's*](https://store.steampowered.com/app/342610) non-Euclidean geometry.

  Systems that lack tactical positioning or rely on reflex-driven mechanics would likely disqualify a game from the roguelike genre. For example, chaotic freeform movement like [*Diablo*'s](https://en.wikipedia.org/wiki/Diablo_\(video_game\)) click-to-move combat does not emphasize meaningful positional strategy. Similarly, fast-paced, reflex-heavy systems such as [*Hades’*](https://store.steampowered.com/app/1145360) dash-spam mechanics prioritize quick reactions over deliberate
  planning, undermining the genre’s core emphasis on tactical depth.

  ##### Spatial Clarity

  Roguelikes thrive on providing players with clear spatial mechanics that allow for meaningful positional decisions. Whether the design uses grids, hexes, or discrete zones, the key is ensuring that each movement feels deliberate. For instance, [*Into the Breach*](https://store.steampowered.com/app/590380) uses a tile-based system to highlight every action’s consequences, giving players complete visibility into potential outcomes.

  [*Terminus: Zombie Survivors*](https://store.steampowered.com/app/1534980) offers an alternative approach by combining a graph-based overworld map with grid-based nodes for each specific building or structure. On the overworld, players choose their next destination node from a web of interconnected locations. Once inside a node, movement and combat initiation occur on a grid, governed by action points that determine how many moves or actions can be taken before ending the turn. After the player uses these points, zombies move in response, reinforcing the importance of thoughtful positioning and resourceful tactics.
...
* #### (iii) Tactical Prioritization Over Strategic Planning
  ...
  Speed is a hallmark of tactical roguelikes, ensuring players face a steady stream of meaningful decisions with immediate consequences. This design philosophy traces back to [*Rogue*](https://en.wikipedia.org/wiki/Rogue_\(video_game\))
  ...
  * *Adaptive Animations*: Games like [*Jupiter Hell*](https://store.steampowered.com/app/811320) use snappy animations that don’t slow turn resolution, preserving momentum.
  * *Concise Scope*: Smaller levels ([*Into the Breach*](https://store.steampowered.com/app/590380)) or action-point systems ([*Terminus: Zombie Survivors*](https://store.steampowered.com/app/1534980)) minimize decision fatigue.

  By contrast, simulationist roguelikes ([*Caves of Qud*](https://store.steampowered.com/app/333640/), [*Dwarf Fortress*](https://store.steampowered.com/app/975370) often embrace slower pacing to accommodate environmental storytelling and systemic depth.
...
* #### (i) Individual or Small Party Emphasis
  ...
  Focusing on a single character or small party naturally heightens the stakes. Unlike larger-scale strategy games like [*XCOM: UFO Defense*](https://en.wikipedia.org/wiki/X-COM:_UFO_Defense), roguelikes often revolve around a single hero whose survival is paramount. Every injury or setback feels personal, amplifying the tension of every turn or encounter.
  ...
  The gallery below contrasts [*XCOM's*](https://en.wikipedia.org/wiki/X-COM:_UFO_Defense) squad-management interface and mechanics with the intimate, singular focus of roguelike design.

<LightboxGallery caption="Image Gallery: XCOM: UFO Defense">
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-28-musings-on-the-berlin-interpretation-part-zwei/xcom_original_geoscape.png" alt="XCOM: UFO Defense (Geoscape), Microprose" description="Screenshot of XCOM's Geoscape, the mission planning and prioritization overview, illustrating the game's emphasis on large-scale strategy and team management rather than single-character survival typical of roguelikes. (This game was released as UFO: Enemy Unknown in Europe.)" caption="Geoscape" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-28-musings-on-the-berlin-interpretation-part-zwei/xcom_original.png" alt="XCOM: UFO Defense (Tactical Battle View), Microprose" description="Screenshot of XCOM's tactical battle view, showcasing turn-based combat with a squad of soldiers, highlighting its focus on managing multiple units and strategic planning instead of the single-hero focus found in traditional roguelikes." caption="Tactical Battle View" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-28-musings-on-the-berlin-interpretation-part-zwei/xcom_original_base_layout.png" alt="XCOM: UFO Defense (Base Layout), Microprose" description="Screenshot of XCOM's base layout, showcasing strategic resource management and facility upgrades that emphasize team-wide planning and support, differentiating it from the single-character focus typical of traditional roguelikes." caption="Base Layout" />
</LightboxGallery>
...
* #### (ii) Permissible Meta-Progression
  ...
  For instance, games like [*FTL*](https://store.steampowered.com/app/212680) allow players to unlock new ships or layouts after achieving specific milestones, providing variety without diminishing the tension of individual runs. Similarly, lore-based progression, as seen in [*ADOM*](https://store.steampowered.com/app/333300),
...
* #### (ii) Resource Management and Exploration
  ...
  [*Brogue*](https://github.com/tmewett/BrogueCE) and others, food management adds another layer of tension, as prolonged exploration risks starvation. This constant pressure encourages players to think ahead, prioritize their needs, and adapt their strategies on the fly.
...
* #### (i) Interlocking Systems
  ...
  This interactivity drives engagement by encouraging players to think beyond immediate problems and consider the broader implications of their actions. Games like [*Dwarf Fortress*](https://store.steampowered.com/app/975370) (in Adventure Mode) exemplify this, offering systems so deeply interconnected that even small changes ripple outward in unpredictable ways.
...
* ### Aesthetic Freedom
  ...
  * *Tactical Clarity*: Games like [*Jupiter Hell*](https://store.steampowered.com/app/811320) and [*Brogue*](https://github.com/tmewett/BrogueCE) use clean, readable visuals (e.g., color-coded enemies, terrain contrast) to optimize decision-making speed. Animations, when present, are minimal to avoid disrupting flow.
  * *Simulationist Abstraction*: Titles like [*Caves of Qud*](https://store.steampowered.com/app/333640/) and
    [*NetHack*](https://github.com/NetHack/NetHack) leverage minimalist aesthetics (ASCII or simple tiles) to prompt player imagination, akin to reading a book. Abstract graphics allow developers to focus on systemic depth without being constrained by art pipelines. Both approaches prioritize function over form, but their goals differ: tactical clarity enables precision, while abstraction fosters immersion.
* ### Modal Flow
  ...
  [*Terminus: Zombie Survivors*](https://store.steampowered.com/app/1534980) demonstrates this by balancing its modal combat with a dynamic overworld exploration system, ensuring that the flow of the game remains consistent and engaging. While the combat is distinct from the movement phase, the design preserves the tension and stakes of every decision, a hallmark of the roguelike experience.
...
* ### Enforced Permadeath
  ...
  [*Caves of Qud*](https://store.steampowered.com/app/333640/) offers two optional non-permadeath difficulty mode with checkpoints, allowing players to recover from setbacks without starting over completely. This approach preserves the tension of permadeath while offering a less punishing experience for those who prefer that.
...
* ### ASCII Requirement
  ...
  For instance, [*Jupiter Hell*](https://store.steampowered.com/app/811320) uses high-quality 3D visuals to represent its environments and characters while retaining the tactical clarity of its ASCII predecessors.

  Other games, including [*Brogue*](https://github.com/tmewett/BrogueCE) and [*Cogmind*](https://store.steampowered.com/app/722730/) provide the option of choosing ASCII or graphical tiles in-game.
...
* ### Strict Non-Modality
  ...
  Classic roguelikes often integrated exploration and combat seamlessly within a single interface. While this approach remains effective, modern roguelikes have shown that modal systems can work just as well. Games like [*FTL*](https://store.steampowered.com/app/212680) segment different phases of gameplay -- such as exploration and ship combat -- but maintain a cohesive and strategic experience.
...
* ### Dungeon-Centric Settings
  ...
  For example, [*Approaching Infinity*](https://store.steampowered.com/app/551620) trades traditional dungeon crawling for starship exploration and planetary away missions, whereas [*HyperRogue*](https://store.steampowered.com/app/342610) warps the player out of normal space entirely and into a non-Euclidean hyperspace nightmare.
...
* ### Legacy Respect
  ...
  Roguelikes trace their roots to foundational titles like [*Rogue*](https://en.wikipedia.org/wiki/Rogue_\(video_game\)), [*NetHack*](https://github.com/NetHack/NetHack), [*Moria*](https://en.wikipedia.org/wiki/Moria_\(1983_video_game\)) and [*Angband*](https://github.com/angband/angband). For many in the community, these early games represent the heart of the genre, establishing key principles such as procedural generation, high-stakes gameplay, and emergent complexity.

  While innovation is essential for keeping the genre alive, it’s important to respect these traditions. This doesn’t mean rigid adherence to past conventions but rather maintaining the core elements that made roguelikes distinctive. For example, modern games like [*Caves of Qud*](https://store.steampowered.com/app/333640/) and [*Jupiter Hell*](https://store.steampowered.com/app/811320) have successfully built on traditional frameworks while introducing fresh ideas. By preserving the genre’s defining principles, developers can ensure its legacy remains intact.
...
* ### Cultural Conflation
  ...
  * [*Vampire Survivors*](https://store.steampowered.com/app/1794680) is frequently mislabeled as a roguelike despite its arcade-style action and minimal consequence for failure.
  * [*Returnal*](https://store.steampowered.com/app/1649240) markets itself as a roguelike but emphasizes real-time combat and cinematic storytelling over tactical decision-making. It is more accurately classified as an action roguelite.
  * [*Cult of the Lamb*](https://store.steampowered.com/app/1313140), although often labeled otherwise, is not a roguelike because it features real-time action, incorporates persistent progression and base-building mechanics, focuses on managing a cult rather than a single character, and lacks traditional roguelike elements like turn-based, grid-based movement and permanent consequences.
...
<LightboxGallery caption="Image Gallery: These are NOT roguelikes">
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-28-musings-on-the-berlin-interpretation-part-zwei/vampire_survivors.jpg" alt="Vampire Survivors, poncle" description="Screenshot of Vampire Survivors, an action game with roguelike-inspired wave-based gameplay, but it operates in real-time without turn-based or grid-based systems." caption="Vampire Survivors" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-28-musings-on-the-berlin-interpretation-part-zwei/returnal.jpg" alt="Returnal, Housemarque/Climax Studios" description="Screenshot of Returnal, a third-person shooter roguelite with procedural generation, permadeath, and limited meta-progression." caption="Returnal" />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-01-28-musings-on-the-berlin-interpretation-part-zwei/cult_of_the_lamb.png" alt="Cult of the Lamb, Massive Monster" description="Screenshot of Cult of the Lamb, a game that blends roguelike features with real-time action, persistent progression, and base-building, deviating from traditional roguelike mechanics." caption="Cult of the Lamb" />
</LightboxGallery>
...
* ### Technology and Player Preferences
  ...
  In order to attract more players to the genre, more approachable and visually engaging experiences go a long way. Games like [*Jupiter Hell*](https://store.steampowered.com/app/811320) demonstrate that roguelikes can embrace modern visuals while retaining their tactical depth. Similarly, hybrids like [*KeeperRL*](https://store.steampowered.com/app/329970) show how blending genres can attract new audiences while preserving roguelike principles.
* ### Adaptive Definition
  ...
  This flexibility ensures that roguelikes remain relevant in an ever-changing gaming landscape. Developers are free to experiment with new mechanics, aesthetics, or narrative techniques, provided they enhance the genre’s core appeal. For example, games like [*Rift Wizard*](https://store.steampowered.com/app/1271280),
  [*Rift Wizard 2*](https://store.steampowered.com/app/2058570) and [**Slay the Spire**](https://store.steampowered.com/app/646570) reimagine traditional roguelike elements in innovative ways, expanding the genre’s possibilities without losing its essence.
...
<div class="checklist">
  ...
  *Key*: Modern roguelikes relax traditional principles (e.g., grids, permadeath) but retain systemic depth and  actical focus.
...
* ***Procedural Generation***: The algorithmic creation of game content -- such as levels, maps, encounters, or loot -- rather than relying solely on hand-designed assets. This approach ensures that each play-through is unpredictable and unique.
...
[Zeno Rogue](https://bsky.app/profile/zenorogue.bsky.social), who clearly demonstrated that they were far more knowledgeable than I on matters of roguelike history and minutiae.
...
If you have a few minutes to spare, why not take [Zeno Rogue's](https://bsky.app/profile/zenorogue.bsky.social) impressively in-depth [Roguelike Quiz](https://zenorogue.itch.io/isitrl)?
