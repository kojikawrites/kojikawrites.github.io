...
author: hiive
description: >-
  A practical exploration of adapting Shaun LeBron’s Pac-Man maze generation
  algorithm for a lightweight tower defense game. The post outlines the process
  of implementing LeBron’s tetromino-based maze generation approach in Python,
  with adjustments made to suit specific gameplay and aesthetic requirements. It
  discusses the challenges of generating symmetrical, pathable mazes and
  introduces a segmentation strategy for pathfinding that balances visual
  clarity with algorithmic efficiency. This entry marks the beginning of a
  series documenting the development of a maze-centric game designed to support
  a broader, yet-to-be-announced project.
categories:
  - gamedev
  - graphics
...
tags:
  ...
  - python
thumbnail: >-
  /src/assets/images/hiivelabs.com/blog/2025-06-01-pacman-not-pacman/thumbnail.png
---
## Not Pacman!
...
For reasons as yet unspecified, the unnamed project in question requires a simple game to be produced. It has to besimple enough to be easily understood from both a gameplay *and* a code perspective, while still being complex enough to generate sufficiently interesting<FootnoteRef id="1" /> data.

<FootnoteDefinition id="1">
  I have a specific **definition** of "interesting" in mind here that I'm not going to explain. When I get further along in the project, I'll discuss it in more detail, but I don't want to jinx things just as I'm getting started.
</FootnoteDefinition>
...
Specifically, [Shaun LeBron's Website](https://shaunlebron.github.io/pacman-mazegen/) details an excellent approach in great detail, and I looked to this for inspiration<FootnoteRef id="2" />.

<FootnoteDefinition id="2">
  And by "inspiration" I mean I stole it wholesale and converted his algorithm to Python (with a few tweaks for my own nefarious purposes).
</FootnoteDefinition>
...
1. Fill a playfield of half the intended width and full intended height with tetrominoes, packed as well as possible
   from right to left. (Imagine a game of Tetris on its side.)
...
<LightboxGallery caption="Pacman Maze Debug Views">
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-06-01-pacman-not-pacman/debug-maze-1.png" alt="Pacman-Style Maze - Debug View" caption="Tetromino edges are eroded to form paths." />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-06-01-pacman-not-pacman/debug-maze-2.jpg" alt="Pacman-Style Maze - Debug View" caption="Each maze tile is made up of a 3×3 set of sub-tiles." />
</LightboxGallery>
...
<LightboxGallery caption="Pacman Maze Vectorized Rendering">
  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-06-01-pacman-not-pacman/maze-parts.png" alt="Pacman-style maze tileset." caption="Any generator-produced Pacman-style maze can be built with these 16 tiles." />

  <GalleryImage image="/src/assets/images/hiivelabs.com/blog/2025-06-01-pacman-not-pacman/vector-maze-render-1.png" alt="Pacman-style maze, rendered in vector-based tiles." caption="An example Pacman-style maze, rendered in vector-based tiles." />
</LightboxGallery>
...
<LightboxImage
  image="/src/assets/images/hiivelabs.com/blog/2025-06-01-pacman-not-pacman/vector-maze-render-2.png"
  alt="An example Pacman-style maze, rendered in
vector-based tiles, showing pathways in gray."
  caption="Pacman-style maze showing path lines."
/>

For various reasons that I will not go into here, but that are relevant for the final product<FootnoteRef id="3" />, I made a deliberate choice not to do it this way. Instead, I chose to partition the maze in "board game" fashion, as shown in the following image:

<FootnoteDefinition id="3">
  Again, I'm not intending to be deliberately obtuse, but I do want to keep the "why" under wraps until the project I'm working on is formally announced.
</FootnoteDefinition>

<LightboxImage
  image="/src/assets/images/hiivelabs.com/blog/2025-06-01-pacman-not-pacman/vector-maze-render-3.png"
  alt="An example Pacman-style maze, rendered in vector-based tiles,
showing traversable tiles in gray outline."
  caption="Pacman-style maze showing path tiles"
/>
