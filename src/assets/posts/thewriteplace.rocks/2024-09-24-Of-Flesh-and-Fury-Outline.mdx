...
description: >-
  I've crafted this detailed outline for creating a visceral body horror narrative,
  following a detective's descent into darkness while hunting a deranged killer. Each
  beat progressively intensifies the horror and psychological tension, from the initial
  shocking discovery through to the final confrontation. The structure weaves together
  elements of police procedural and psychological thriller with graphic body horror,
  building toward a haunting conclusion that leaves lasting scars on both the characters
  and reader.
categories:
- outline
author: K°
