...
description: >-
  This is my take on the three-act structure, focusing on two crucial doorways that
  transform the protagonist's journey. I break down how these transition points work
  with a story's disturbance and climax, creating a clear path through your narrative.
  While it works beautifully with adventure and sci-fi, I've found this framework
  adapts well to any genre where characters face life-changing choices, from emotional
  journeys to romance.
categories:
- outline
author: K°
