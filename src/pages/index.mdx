...
import HiiveLabs from '../components/custom/hiivelabs/HiiveLabsText.astro'
...
<div class="container">
    ...
    **[Welcome](about) to <HiiveLabs />**.
    ...
    players. [Discover](blog) how AI and human ingenuity can come together to create compelling gaming experiences
    at <HiiveLabs />.
</div>
