 ...
 * Run this during build to update src/build/generators/categories.ts and tags.ts
 */
...
const postsDir = path.join(__dirname, `../.sites/${SITE_CODE}/content/posts`);
...
const onbuildDir = path.join(__dirname, 'generators');
