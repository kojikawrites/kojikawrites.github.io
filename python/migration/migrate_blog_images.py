...
class BlogImageMigrator:
    def __init__(self, site_code: str, dry_run: bool = False, update_src_to_image: bool = False):
        ...
        self.root_dir = Path(__file__).parent.parent.parent  # Go up from python/migration to repo root
        self.blog_posts_dir = self.root_dir / f"src/.sites/{site_code}/content/posts"
        self.blog_images_dir = self.root_dir / f"src/.sites/{site_code}/images/blog"
    ...
    def build_slug_based_path(self, slug: str, image_filename: str) -> str:
        ...
        return f"/src/.sites/{self.site_code}/images/blog/{slug}/{image_filename}"
